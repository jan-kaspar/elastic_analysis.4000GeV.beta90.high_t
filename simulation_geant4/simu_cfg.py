...
elasticGenerator = True
seed = 8
events = 2E5
tag = "_2E5_seed8"
#tag = "_flat_1E5_seed1"
#tag = "_th_y_low_3E4_seed2"
#tag = "_th_y_high_2E4_seed2"
...
if elasticGenerator:
	...
	process.generator.t_max = 1.5
else:
    process.load("IOMC.FlatThetaXYGun.FlatThetaXYGun_cfi")
    process.generator.verbosity = 1
    process.generator.energy = 4000
    process.generator.th_x_min = -300E-6
    process.generator.th_x_max = +300E-6
    #process.generator.th_y_min = +20E-6
    #process.generator.th_y_max = +45E-6
    process.generator.th_y_min = +85E-6
    process.generator.th_y_max = +110E-6
    #process.generator.th_y_min = +0E-6
    #process.generator.th_y_max = +130E-6
...
process.XMLIdealGeometryESSource.geomXMLFiles.append('../user/elastic_analyses/4000GeV,beta90,high_t/simulation_geant4/RP_Dist_Beam_Cent.xml')
