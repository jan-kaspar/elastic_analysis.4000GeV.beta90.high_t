...
void Init_base()
{
	...
	// (used for unfolding, systematics, ...)
	...
	anal.si_th_y_1arm_unc = 0.35E-6 / sqrt(2.);	// comprising full time dependence (band 3.05 to 3.65)
	anal.si_th_x_1arm_unc = 0.25E-6 / sqrt(2.);	// comprising full time dependence (bands 9.1 to 9.6 and 8.45 to 8.95)
...
void Init_45t_56b()
{
	...
	anal.inefficiency_pile_up = 0.010;
}
