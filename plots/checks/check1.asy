...
//draw(RootGetObject("/eos/user/j/jkaspar/work/analyses/elastic/4000GeV/beta90/main/DS-merged/merged.root", "ob/DS4-sc/combined/h_dsdt"), "vl", green, "test");

// from NPB 899 (2015) 527-546, Table 3
AddToLegend("NPB 899, Table 3", blue);
